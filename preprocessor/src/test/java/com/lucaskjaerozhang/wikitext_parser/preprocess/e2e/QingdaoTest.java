...
class QingdaoTest extends PreprocessorEndToEndTest {
  private static final String TIME_SHIM = "<module name='time'><argument>U</argument></module>";
  ...
  void ifNotEq() {
    testPreprocessorWithString(
        ...
        "<ref group='註\u2060' follow='NoSpaceReferences_Prefix_"
            + TIME_SHIM
            + "'><div style=\"margin-left:-2.7em;margin-bottom:-1.5em\" class=\"noprint\">註:</div></ref>");
    testPreprocessorWithString(
        ...
        "<div id=\"references-NoSpaceReferences\"><ref group='註\u2060' follow='NoSpaceReferences_Prefix_"
            + TIME_SHIM
            + "'><div style=\"margin-left:-2.7em;margin-bottom:-1.5em\" class=\"noprint\">註:</div></ref><references group='註\u2060'>{{{1}}}</references>|<module name='Error'><argument>error</argument><argument>引用錯誤：group屬性不能為空</argument><argument>tag=</argument></module>");
  }
  ...
  void nsReferencesTag() {
    testPreprocessorWithString(
        ...
        "<ref group='{{{group}}}\u2060' follow='NoSpaceReferences_Prefix_"
            + TIME_SHIM
            + "'><div style=\"margin-left:-2.7em;margin-bottom:-1.5em\" class=\"noprint\">{{{group}}}:</div></ref>");
  }
}
